...
- **Species verification:** AR text explicitly names *Falco vespertinus* / Red-footed Falcon (عويسق أحمر). This is **not** the Common Kestrel (*Falco tinnunculus*).
- Featured image (legacy WP): `MED-136434753561-519-11.jpg`.
- Short archive piece (2013); full body is a single paragraph in source.
