...
Pressures include habitat loss, climate change and extreme weather, pesticides, disease, and collisions with buildings and structures. Researchers therefore call for protection that takes account of the bird’s full life cycle and links efforts among the countries it crosses.  
Source: BTO and the scientific review; results presented 28 July.
...
BirdLife says the channel linking Narta Lagoon to the sea was closed during the works and then reopened, warning of the effect of disrupting water flow on the lagoon’s balance and birds’ food. The case reveals a basic side of protection: the bird needs a place fit for life when it lands.  
Source: BirdLife, 7 September 2026.
...
The lesson of this journey is that protecting one site gains greater value when connected to protecting the other sites the bird needs.  
Source: BirdLife, 26 August 2026.
...
- Ferruginous Duck: AR «البط الحديدي»; English common name as stated in source (no Latin binomial in source).
- European Turtle Dove: English as in source (no Latin in source).
- Photo captions/credits preserved (Wikimedia / iNaturalist).
- Dates: 28 July, 7 September 2026, 26 August 2026, 18 July as in AR.
